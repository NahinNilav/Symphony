...
if TYPE_CHECKING:
    from symphony.context import ExecutionContext

class Task:
    """
    A single executable unit within a Symphony flow.
    ...
    def __init__(
        ...
        if not execute or not callable(execute):
            raise SymphonyError("Task must have a callable execute function")
